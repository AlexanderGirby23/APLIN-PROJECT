        ...
        if (empty($fname) || empty($lname) || empty($email) || empty($dom) || empty($nik) || empty($ph) || empty($pass) || empty($gender)) {
          ...
          if ($pass == $cpass) {
            ...
            if (mysqli_num_rows($res) > 0) {
              ...
              $sql = "insert into users (FNAME,LNAME,EMAIL,DOMICILE,NIK,PHONE_NUMBER,PASSWORD,GENDER,nik_photo) values('$fname','$lname','$email','$dom','$nik',$ph,'$Pass','$gender','$new_img_name')";
